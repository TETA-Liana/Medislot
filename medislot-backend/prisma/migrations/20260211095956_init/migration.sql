...
-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('UPCOMING', 'COMPLETED', 'CANCELLED', 'PENDING_CONFIRMATION');
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
